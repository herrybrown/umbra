      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="hidden text-[10px] text-arc-muted font-mono border border-arc-border rounded px-1 sm:inline">
              testnet
            </span>
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden px-3 py-1.5 rounded-md text-sm text-arc-muted hover:text-white hover:bg-arc-border/50 transition-colors sm:inline-flex"
          >
            Faucet
          </a>
          <ConnectWallet />
